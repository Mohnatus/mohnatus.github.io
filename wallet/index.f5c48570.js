...
_state.subscribe(_state.fields.items, _state.events.update, (items)=>{
    (0, _items1.renderItemsList)(items);
});
...
},{"./js/db":"aF8BE","./js/db/items":"g7UNv","./js/db/tags":"4asb7","./js/state":"8eIFt","./js/view/itemForm":"ls1cb","./js/view/items":"hxYzp","./js/view/tagForm":"a9hVv","./js/view/tags":"74Zyy","./js/utils/notifier":"7aVBF"}],"aF8BE":[function(require,module,exports) {
...
function init({ tags: tagsList, items: itemsList }) {
...
},{"./elements":"8Ekdt","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"74Zyy":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./elements":"8Ekdt","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["fH7gS","8ZNvh"], "8ZNvh", "parcelRequire1d24")
